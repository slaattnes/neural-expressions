...
#
# Raspberry Pi motor library is used for motor control of 28BYJ-48 Stepper motors + ULN2003 driver boards.
#
# Stepper motors actuate wire-driven tentacle based on the input.
#
# Author: Daniel Slåttnes
# Based on https://github.com/gavinlyonsrepo/RpiMotorLib/blob/master/test/MultiMotorThreading_BYJ.py
